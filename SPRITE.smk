...
try:
    ...
    INFO += 'Scripts will be found in: ' + scripts_dir +'\n'
except:
    scripts_dir = ''
    INFO += 'Defaulting to working directory as scripts directory\n'

#Location of scripts
barcode_id_jar = scripts_dir + "java/BarcodeIdentification_v1.2.0.jar"
lig_eff = scripts_dir + "python/get_ligation_efficiency.py"
split_fq = scripts_dir + "python/get_full_barcodes.py"
...
assert os.path.isfile(hicorrector_path), f'HiCorrector ic not found at {hicorrector_path}'
assert os.access(hicorrector_path, os.X_OK), f'HiCorrector ic is not executable: {hicorrector_path}'
